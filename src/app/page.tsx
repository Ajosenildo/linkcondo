// src/app/page.tsx
// CORRIGIDO: Tela de Login Inicial (Apenas formulário e contatos).
// NÃO IMPORTA RESERVAS NEM BOLETOS AQUI.
...
// TELA DE LOGIN (Corrigida: Sem importação de ReservasContent)
      ...
      {tenantLoading ? (
        ...
        tenantData?.logo_url && (
          <div className="flex flex-col items-center justify-center space-y-2 mb-4">
            ...
            {/* Exibe os contatos se existirem */}
            {(tenantData.email_contato || tenantData.telefone_contato) && (
              <div className="text-center text-xs text-gray-500 mt-1">
                {tenantData.email_contato && <p>📧 {tenantData.email_contato}</p>}
                {tenantData.telefone_contato && <p>📞 {tenantData.telefone_contato}</p>}
